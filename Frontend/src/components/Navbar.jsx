...
function Navbar() {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-16 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
        ...
        <div className="navbar  ">
          ...
          <div className="navbar-end space-x-3">
            ...
            <label className="swap swap-rotate">
              ...
              {/* sun icon */}
              <svg
                className="swap-off fill-current w-7 h-7 size-auto"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
